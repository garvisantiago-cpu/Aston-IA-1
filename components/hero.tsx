      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8">
            ...
            <span className="text-xs font-medium text-white/80 uppercase tracking-wider">Consultoría gratuita</span>
          </div>
        </motion.div>
        ...
        >
          Automatiza tu e-commerce de ropa con agentes IA
        </motion.h1>
        ...
        >
          Agentes inteligentes que atienden 24/7, gestionan stock, generan leads y publican en redes. Menos costos, más
          ventas.
        </motion.p>
